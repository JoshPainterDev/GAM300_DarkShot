...
AVR_PlayerChaperone::AVR_PlayerChaperone()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> SphereVisualAsset(TEXT("StaticMesh'/Game/sphere.sphere'"));
	...
	static ConstructorHelpers::FObjectFinder<USkeletalMesh> BowVisualAsset(TEXT("SkeletalMesh'/Game/ViveMaterials/playerbow.playerbow'"));
	...
	const ConstructorHelpers::FObjectFinder<UAnimBlueprint> AnimObj(TEXT("AnimBlueprint'/Game/ViveMaterials/ABP_Bow.ABP_Bow'"));
